            ...
            <div
                ...
                <div class="p-6">
                    ...
                    <div class="mt-4 flex items-center justify-center gap-4">
                        <button type="button" wire:click="decrementModalQty" wire:loading.attr="disabled"
                            wire:target="decrementModalQty,incrementModalQty,confirmAddToCart"
                            class="w-9 h-9 rounded-lg bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 font-medium text-lg disabled:opacity-40">-</button>
                        <span
                            class="w-10 text-center text-lg font-semibold text-slate-900 dark:text-slate-100">{{ $modalQty }}</span>
                        <button type="button" wire:click="incrementModalQty" wire:loading.attr="disabled"
                            wire:target="decrementModalQty,incrementModalQty,confirmAddToCart"
                            class="w-9 h-9 rounded-lg bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 font-medium text-lg disabled:opacity-40">+</button>
                    </div>
                    ...
                    <div class="mt-6 flex justify-end gap-3">
                        ...
                        <x-primary-button type="button" wire:click="confirmAddToCart" wire:loading.attr="disabled"
                            wire:target="confirmAddToCart,incrementModalQty,decrementModalQty">
