...
<div>
    <div class="mb-6">
        <h1 class="text-xl font-semibold text-slate-900 tracking-tight">{{ __('Buat toko baru') }}</h1>
        <p class="mt-1 text-sm text-slate-500">{{ __('Gratis 30 hari, tanpa kartu kredit.') }}</p>
    </div>
    ...
    <p class="mt-6 text-center text-sm text-slate-500">
        {{ __('Sudah punya akun?') }}
        <a href="{{ route('login') }}" wire:navigate class="font-medium text-brand-600 hover:text-brand-700">{{ __('Masuk di sini') }}</a>
    </p>
</div>
